...
#
# The TFTP server is used by U-Boot on the KR260 to load the FPGA bitstream
# and ramdisk before eMMC programming (scripts 2 & 3).
#
# Usage:
...
printHelp() {
    ...
    # List subdirectories of the script's own directory
...
logBanner "KR260 TFTP Setup – Version: ${selectedVer}"
