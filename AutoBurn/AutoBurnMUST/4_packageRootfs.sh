...
# the eMMC root partition is NOT actively in use and can be safely mounted
# read-only for archiving.
#
# Usage:
...
#   ./4_packageRootfs.sh --name /tmp/backup.tar.gz
# =============================================================================
...
# Default output directory on the host (current dir if --ver not given)
